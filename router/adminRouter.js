...
router.get('/unlistCategory',adminAuth,adminController.unlistCategory)
router.post('/addCategory',adminAuth,adminController.addCategory)
router.get('/listCategory',adminAuth,adminController.listCategory)
...
router.post('/blockBrand/:brandId',adminAuth,adminController.unlistBrand)
router.post('/unblockBrand/:brandId',adminAuth,adminController.listBrand)
router.post('/editBrand/:brandId',adminAuth,adminController.editBrand)
